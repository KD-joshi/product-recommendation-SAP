...
def main():
    ...
    parser.add_argument("--skip-images", action="store_true", help="Skip building image embeddings entirely")
    parser.add_argument("--use-cached-images", action="store_true", help="Use cached image embeddings if they exist instead of rebuilding")
    ...
    search.initialize(
        use_hnsw=True, 
        build_image_index=not args.skip_images,
        force_image_rebuild=not args.use_cached_images
    )
